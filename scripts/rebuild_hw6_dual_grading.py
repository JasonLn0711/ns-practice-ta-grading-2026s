...
ROWS = [
    ...
    row("514660010", "林煜樺", "submissions/hw6/renamed/hw6_514660010_01_homework-6.ipynb", (25, 20, 25, 20, 10), (40, 20, 25, 15), "A", "A", "", "", "Complete code evidence: low-score review confirmed an embedded computational graph with source-code notation, forward/backward flow, momentum updates, result evidence, and traceable outputs.", "Complete figure evidence: embedded computational graph, learned filters, labeled input, and conv/ReLU/pool feature maps are present and auditable.", [], []),
