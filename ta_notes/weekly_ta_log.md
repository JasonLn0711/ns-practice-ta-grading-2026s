...
Use this for TA work summaries only. Do not store detailed student-sensitive review notes here.

## 2026-W17

- BEBN20024 TA grading workspace created.
- HW5 course/reference materials copied into `course_materials/hw5/` with raw originals and renamed working copies.
- HW5 MNIST gzip IDX files verified and copied into `course_materials/hw5/raw/mnist/` and `course_materials/hw5/renamed/mnist/`.
