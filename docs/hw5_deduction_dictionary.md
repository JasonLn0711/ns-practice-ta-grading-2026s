...
| `NO_HYPERPARAMETER_SEARCH_EVIDENCE` | Hyperparameter choices are missing or not visibly determined. | 5-20 | no | `Missing/weak evidence for <hidden nodes/lr/batch/epoch/search>.` |
